...
categories: [Base de datos, Mysql]
tags: [Relacional, Querys]
home_image: banner
banner:
  path: /assets/posts/mysql.png
  alt: "MySQL"
---
...
> - Normalmente el ON de un JOIN relaciona la PK con la FK
{: .prompt-tip }
...
> - En una relación N:N, la tabla intermedia siempre va en medio para poder usar LEFT JOIN o RIGHT JOIN entre las tablas principales.
{: .prompt-tip }
...
```
> - UNION agrega filas, NO columnas. Se apilan las filas una debajo de la otra.
{: .prompt-tip }
...
> - Permite encontrar filas rápidamente sin recorrer toda la tabla, a costa de usar más espacio y hacer un poco más lentas las inserciones y actualizaciones.
{: .prompt-info }
...
UPDATE users SET email = 'eldementor@gmail.com' WHERE user_id = 1
